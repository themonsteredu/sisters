...
import { BookCopy, BookOpen, CalendarDays, Check, ChevronLeft, ChevronRight, ClipboardPaste, Headphones, Layers3, Plus, Sparkles, WandSparkles, X } from "lucide-react";
